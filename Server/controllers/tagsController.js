...
exports.createTag = async (req, res) => {
    ...
    try {
        const result = await tagsService.createTag(tag_nm, created_by);
...
exports.updateTag = async (req, res) => {
    ...
    try {
        await tagsService.updateTag(id, tagName, req.email);
        await authService.logActivity(req.id, `User: ${req.email} updated a tag: [${tagName}]`);
...
exports.saveSearchedTag = async (req, res) => {
    ...
    try {
        await tagsService.saveSearchedTag(tagId, searchedBy);
